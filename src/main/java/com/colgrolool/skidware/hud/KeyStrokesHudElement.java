...
public class KeyStrokesHudElement extends HudElement {
    public static final HudElementInfo<KeyStrokesHudElement> INFO = new HudElementInfo<>(SkidHud.SKIDHUD, "Keys", "Draws current movement keys", KeyStrokesHudElement::new);
    ...
    private final Setting<SettingColor> cbgColor = sgGeneral.add(new ColorSetting.Builder()
        ...
        .description(".")
        .defaultValue(new SettingColor(50,50,50,155))
        .visible(textBG::get)
        .build()
    );
