...
public class TargetHudElement extends HudElement {
    ...
    public static final HudElementInfo<TargetHudElement> INFO = new HudElementInfo<>(SkidHud.SKIDHUD, "TargetHud", "A target hud the fuck you thinkin bruv", TargetHudElement::new);
