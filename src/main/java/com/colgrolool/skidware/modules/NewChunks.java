...
*/
/*
    Stolen from: https://github.com/AntiCope/meteor-rejects/blob/master/src/main/java/anticope/rejects/modules/NewChunks.java
*/
public class NewChunks extends Module {
    ...
    public NewChunks() {
        super(SkidModules.SKIDCAT,"new-chunks", "Detects completely new chunks using certain traits of them");
    }
